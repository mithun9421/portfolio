      ...
      <div className="mx-auto max-w-2xl px-6 md:px-12">
        ...
        <div className="mt-10 space-y-12">
          ...
          <RevealOnScroll delay={0.1}>
            <section>
              <SectionHeading className="mb-4">Building Teams</SectionHeading>
          ...
          <RevealOnScroll delay={0.3}>
            <section>
              <SectionHeading className="mb-4">UI/UX Leadership</SectionHeading>
              <div className="space-y-3">
                <BodyText className="text-foreground-muted">
          ...
          <RevealOnScroll delay={0.4}>
            <section>
              <SectionHeading className="mb-4">Measurable Impact</SectionHeading>
              <div className="space-y-3">
                <BodyText className="text-foreground-muted">
